...
public class Setting {
	...
	public static void main(String[] args) {
		...
		try {
			var con = DriverManager.getConnection("jdbc:mysql://localhost/?serverTimezone=UTC&allowLoadLocalInfile=true", "root", "alfla");
			...
			// CRUD U update
			var con2 = DriverManager.getConnection("jdbc:mysql://localhost/2022지방_2?serverTimezone=UTC&allowLoadLocalInfile=true", "root", "alfla");
